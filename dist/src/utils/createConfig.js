...
export async function createConfig(platformCredentials, appName, bundleId) {
    ...
    const config = {
        ...
        notifications: {
            telegram: {
                enabled: false,
                messageTemplate: "🚀 New version *{{version}}* of *{{projectName}}* has been uploaded successfully to *{{platform}}!*",
            },
        },
    };
